...
- **Github Repo** - [slackerrorsim](https://github.com/lakshaykapoor08/slackerrorsim)
...
1. Open the Slack-Error-Sim application
...
```
curl -X POST 'https://slackerrorsim.vercel.app/api/v1/error/400' \
